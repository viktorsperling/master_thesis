...
\begin{lstlisting}[language=Bash, caption=Angular CLI console command to enable Module Federation in an Angular project, label=list:angluar_wmf_command, xleftmargin=.05\textwidth, xrightmargin=.05\textwidth]
...
\begin{lstlisting}[language=JavaScript, caption=Content of \texttt{webpack.config.js} of the shell of the same versions WMF project, label=list:wmf_sameversions_shell, xleftmargin=.05\textwidth, xrightmargin=.05\textwidth]
[...]
module.exports = {
	[...]
	plugins: [
