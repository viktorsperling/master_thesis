...
One way of avoiding redundant libraries can be a central source, where all resources are stored and can be requested from via an API. Such a concept exists in the idea of Content Delivery Networks (CDNs).
