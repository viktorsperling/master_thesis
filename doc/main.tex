...
\lstdefinelanguage{JavaScript}{
	morekeywords={typeof, new, true, false, catch, function, return, null, catch, switch, var, if, in, while, do, else, case, break,class,super,let,const,this,constructor,import,from,export,default,extends,render,for,of,@Component,@Input,implements,private,@ViewChild,await,type,string,async},
	morecomment=[s]{/*}{*/},
	morecomment=[l]//,
	morestring=[b]",
	morestring=[b]',
